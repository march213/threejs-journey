...
const tick = () => {
  ...
  //   const i3 = i * 3;
  //   const x = customParticlesGeometry.attributes.position.array[i3];
  //   customParticlesGeometry.attributes.position.array[i3 + 1] = Math.sin(elapsedTime + x);
  // }

  // customParticlesGeometry.attributes.position.needsUpdate = true;
