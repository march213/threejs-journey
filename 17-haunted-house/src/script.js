...
const bricksAmbientOcclusionTextures = textureLoader.load('/textures/bricks/ambientOcclusion.jpg');
...
const walls = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    aoMap: bricksAmbientOcclusionTextures,
